# Тестовое задание
1. Необходимо составить SQL-запрос, который вернет фамилию сотрудника со вторым максимальным опытом работы.<br/>
  _SELECT MAX( col )_<br/>
  _FROM table_<br/>
  _WHERE col < ( SELECT MAX( col )_<br/>
  _FROM table )_<br/>
  
2. Есть 2 целочисленных переменных a и b, в которых хранятся определенные значения.<br/>
